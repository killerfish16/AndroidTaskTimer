 ...
 * @constructor Create empty App provider
 */
private const val TAG = "AppProvider"
val CONTENT_AUTHORITY = "com.learning.mobile.tasktimer.provider"
...
class AppProvider : ContentProvider() {
    ...
    private fun buildUriMatcher(): UriMatcher {
        ...
        //e.g. content://com.learning.mobile.tasktimer.provider/Tasks
        matcher.addURI(CONTENT_AUTHORITY, TasksContract.TABLE_NAME, TASKS)
        //e.g. content://com.learning.mobile.tasktimer.provider/Tasks/8
        matcher.addURI(CONTENT_AUTHORITY, "${TasksContract.TABLE_NAME}/#", TASKS_ID)

        /*matcher.addURI(CONTENT_AUTHORITY, TimingsConstract.TABLE_NAME, TIMINGS)
        matcher.addURI(CONTENT_AUTHORITY, "${TimingsConstract.TABLE_NAME}/#", TIMINGS_ID)

        matcher.addURI(CONTENT_AUTHORITY, DurationsConstract.TABLE_NAME, TASK_DURATIONS)
        matcher.addURI(CONTENT_AUTHORITY, "${DurationsConstract.TABLE_NAME}/#", TASK_DURATIONS_ID)*/
        return matcher
    }
    ...
    override fun insert(uri: Uri, values: ContentValues?): Uri {
        ...
        Log.d(TAG, "Insert completed, returning $returnUri")
        return returnUri
    }
    ...
    override fun update(
        ...
        Log.d(TAG, "update completed, returning count: $count")
        return count
    }
    ...
    override fun delete(uri: Uri, selection: String?, selectionArgs: Array<out String>?): Int {
        ...
        Log.d(TAG, "Delete completed, returning count: $count")
        return count
    }
